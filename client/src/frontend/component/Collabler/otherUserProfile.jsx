...
export default function OtherUserProfile({ userId, type }) {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.log('====================================');
        console.log(collablersResponse.data);
        console.log('====================================');
        ...
        console.log('====================================');
        console.log(allPosts.length, totalDevotes, totalUpvotes , userPosts);
        console.log('====================================');
      } catch (error) {
  ...
  const handleActionClick = async (e) => {
    ...
    switch (type) {
      ...
      case 'received':
        ...
        break;
      case 'collaborator':
        endpoint = `/removeCollaborator/${userId}`;
        method = 'delete';
        break;
      default:
